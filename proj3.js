(function () {
    ...
    class TrackballControls extends THREE.EventDispatcher {
        ...
        constructor(cameraObj, canvasObj) {
            ...
            if (canvasObj === document) {
                console.error('THREE.TrackballControls: "document" should not be used as the target "domElement". ' +
            ...
            this.object = cameraObj;
            this.domElement = canvasObj;
